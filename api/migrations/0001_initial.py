    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customernumber', models.ForeignKey(db_column='customerNumber', on_delete=django.db.models.deletion.DO_NOTHING, to='api.customers')),
            ],
            options={
                'db_table': 'orders',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productline', models.ForeignKey(db_column='productLine', on_delete=django.db.models.deletion.DO_NOTHING, to='api.productlines')),
            ],
            options={
                'db_table': 'products',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officecode', models.ForeignKey(db_column='officeCode', on_delete=django.db.models.deletion.DO_NOTHING, to='api.offices')),
                ('reportsto', models.ForeignKey(blank=True, db_column='reportsTo', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.employees')),
            ],
            options={
                'db_table': 'employees',
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='salesRepEmployeeNumber', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.employees'),
        ),
        migrations.CreateModel(
            name='Payments',
            fields=[
                ('customernumber', models.OneToOneField(db_column='customerNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='api.customers')),
        ...
        migrations.CreateModel(
            name='Orderdetails',
            fields=[
                ('ordernumber', models.OneToOneField(db_column='orderNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='api.orders')),
                ...
                ('productcode', models.ForeignKey(db_column='productCode', on_delete=django.db.models.deletion.DO_NOTHING, to='api.products')),
            ],
            options={
